...
source_suffix = '.rst'
master_doc = 'index'
project = 'Libro bianco sull´innovazione della Pubblica Amministrazione (versione partecipata 2018)'
...
latex_logo = "static/fpa_digital360_negativo.png"
html_logo = "static/fpa_digital360_negativo.png"
